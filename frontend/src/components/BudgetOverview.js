...
const BudgetOverview = (props) => {
  ...
  let expensesPercentage =
    100 -
    ((Number(budget.amount) - expensesAmount) / Number(budget.amount)) * 100;
  console.log(
    "expensesPercentage",
    expensesPercentage,
    typeof expensesPercentage
  );
    ...
    data: [
      {
        ...
        indexLabel: "{name}: {y}",
        yValueFormatString: "#,###'%'",
        dataPoints: [{ name: "Expenses", y: expensesPercentage }],
      },
    ],
    height: 300,
    width: 300,
      ...
      <div className="budgetContainer card ">
        ...
        <div className="flexbox-container ">
          ...
          <div className="fi test2">
            <h3>Total Budget</h3>
            <h4>Rs. {budget ? budget.amount : "0"}</h4>
            <br />
            <br />
